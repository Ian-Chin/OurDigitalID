...
const getNearbyServiceCenters = (): ServiceCenter[] => [
...

  {
    ...
    category: "identity",
    location: "UTM Skudai, Johor Bahru",
    distance: 1.2,
...

  {
    ...
    name: "Tax Office",
    category: "tax",
    location: "Skudai Parade, Johor Bahru",
    distance: 3.1,
  ...
  {
    id: "17",
    name: "Klinik Kesihatan Skudai",
    category: "healthcare",
    location: "Skudai Baru, Johor Bahru",
    distance: 1.5,
    waiting: Math.floor(Math.random() * 12) + 1,
  ...
  },
  {
    ...
    name: "Medical Center",
    category: "healthcare",
    location: "Taman Nusa Bestari, Skudai",
    distance: 4.6,
